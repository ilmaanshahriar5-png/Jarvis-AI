# Jarvis-AI
Jarvis is an open-source, conversational AI assistant that automates workflows, manages smart home devices, and boosts productivity. Its modular architecture connects natural language processing with custom scripts, APIs, and IoT frameworks, offering a lightweight, extendable interface for personal automation. A real-time voice AI that can hear, see, understand, and control your computer — on any OS. Supporting Windows, macOS, and Linux. Local execution. Zero subscriptions. Engineered for total autonomy.
